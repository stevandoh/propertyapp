...
import com.greenfield.propertyapp.utils.wizard.views.CustomerInfoFragment;
...
public class CustomerInfoPage extends Page {
    ...
    public void getReviewItems(ArrayList<ReviewItem> dest) {
        dest.add(new ReviewItem(Constants.FIRSTNAME_LABEL, mData.getString(FIRSTNAME_DATA_KEY), getKey(), -1));
        dest.add(new ReviewItem(Constants.SURNAME_LABEL, mData.getString(SURNAME_DATA_KEY), getKey(), -1));
    }

    @Override
    public boolean isCompleted() {
        return !TextUtils.isEmpty(mData.getString(FIRSTNAME_DATA_KEY)) && !TextUtils.isEmpty(mData.getString(SURNAME_DATA_KEY));
    }
}
